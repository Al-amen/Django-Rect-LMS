...
function Coupon() {
  ...
  const handleCouponSubmit = (e) => {
    ...
    useAxios.post(`teacher/coupon-list/${UserData()?.teacher_id}/`,formdata).then((res)=>{
       ...
       Toast().fire({
        icon:"success",
        title:"Coupn created successfully",
       });
    });
  ...
  const handleDeleteCoupon = (couponId) => {
    useAxios.delete(`teacher/coupon-detail/${UserData()?.teacher_id}/${couponId}/`)
    .then((res)=>{
      console.log(res.data);
            fetchCoupons();
            Toast().fire({
  ...
  const handleCouponUpdateSubmit = (e) => {
    ...
    useAxios
      .patch(`teacher/coupon-detail/${UserData()?.teacher_id}/${selectedCoupon.id}/`, formdata)
      .then((res) => {
                        ...
                        <div className="ms-3 mt-2">
                          <div className="d-flex align-items-center justify-content-between">
                            <div>
                              ...
                              <span>{c.used_by?.length || 0} Student</span>
                            </div>
                          </div>
                          <div className="mt-2">
                            <p className="mt-2">
                              <span className="me-2 fw-bold">
                                Discount:{" "}
                                <span className="fw-light">{c.discount}</span>
                              </span>
                            </p>
                            <p className="mt-1">
                              <span className="me-2 fw-bold">
